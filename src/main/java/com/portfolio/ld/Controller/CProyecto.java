...
import com.portfolio.ld.Dto.dtoProyecto;
import com.portfolio.ld.Entity.Proyecto;
import com.portfolio.ld.Security.Controller.Mensaje;
import com.portfolio.ld.Service.Sproyecto;
...
public class CProyecto {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyecto dtoproyecto){
        ...
        dtoproyecto.getNombreP(), dtoproyecto.getDescripcionP(),dtoproyecto.getImgP(),dtoproyecto.getLink()
        );
